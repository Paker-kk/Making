...
本项目基于开源项目 [**Nano Banana**](https://github.com/JimLiu/nanoBanana) 构建，这是一个轻量级的无限画布编辑器框架。在此基础上，我们：

- 🎯 **类 Lovart 的画面白板体验**  
  借鉴了 [Lovart](https://lovart.com/) 的 UI 设计风格，采用简洁、优雅的界面设计，注重用户体验和视觉美感。可折叠面板、流畅的动画过渡、极简主义美学等设计元素均受 Lovart 启发。

- 📚 **独创的灵感库系统**  
  在 Nano Banana 的画布基础上，增加了完整的灵感库功能，支持角色库、场景库、道具库的分类管理，让创作素材井然有序。这是本项目的核心特色功能之一。
...
3. **⚠️ 配置 API Key（使用 AI 功能时必需）**
   ...
   本项目基于 **Nano Banana** 开发，使用 **Google Gemini API** 进行 AI 图像生成。
...
### 核心基础
- **[Nano Banana](https://github.com/JimLiu/nanoBanana)** - 本项目基于此开源无限画布编辑器构建，感谢 @JimLiu 提供了优秀的基础架构
